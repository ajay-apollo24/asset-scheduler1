-- Unified Campaign Migration
-- This migration unifies the bookings and campaigns tables into a single system
-- that can handle both internal team bookings and external advertiser campaigns

-- Step 1: Add new columns to campaigns table to support internal bookings
...
-- Step 2: Add new columns to campaigns table to support booking-specific fields
ALTER TABLE campaigns 
ADD COLUMN IF NOT EXISTS title VARCHAR(255),
ADD COLUMN IF NOT EXISTS asset_id INTEGER REFERENCES assets(id);

-- Step 3: Create a view to maintain backward compatibility with existing bookings
...
-- Step 4: Create a function to migrate existing bookings to campaigns
...
-- Step 5: Create indexes for the new unified system
...
-- Step 6: Create a unified allocation function
...
-- Step 7: Create a unified bidding function
...
-- Step 9: Create a trigger to maintain data consistency
...
-- Step 10: Create a function to get unified analytics
